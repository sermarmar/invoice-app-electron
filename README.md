...
| Plataforma | Descarga |
|------------|----------|
| Windows | [invoice-app-windows-1.3.0.zip](https://github.com/sermarmar/invoice-app-electron/releases/latest/download/invoice-app-windows-1.3.0.zip) |
| macOS | [invoice-app-macos-1.3.0.zip](https://github.com/sermarmar/invoice-app-electron/releases/latest/download/invoice-app-macos-1.3.0.zip) |
